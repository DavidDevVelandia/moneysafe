<template>
    ...
    import { ref } from "vue";
    import { ShowCategoriesIncomes } from "@/data/categories/categoriesIncomes"
    import CategoryIncomeComp from "./CategoryIncomeComp.vue"
    import { changeName } from "@/data/selectedComponent";
    
    const categories = ref(ShowCategoriesIncomes())
    ...
    function refreshCategories() {
        ...
        categories.value = ShowCategoriesIncomes().value;
    }
    function confirm(){
        emit("confirmed")
    }
